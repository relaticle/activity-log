---
title: Customization
description: Custom renderers, registration channels, and Tailwind theme integration.
navigation:
  icon: i-lucide-paintbrush
seo:
  description: Register custom renderers per event or type, replace the built-in spatie diff renderer, and wire Tailwind for the timeline views in relaticle/activity-log.
  ogImage: /preview.png
---
