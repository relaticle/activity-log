---
title: CRM person feed
description: End-to-end person profile timeline — own log, related logs, timestamp events, custom renderer.
navigation:
  icon: i-lucide-users
seo:
  description: Complete recipe — Person model with emails, notes, tasks; spatie logs + timestamp events + a custom email renderer; Filament infolist + table action.
  ogImage: /preview.png
---
