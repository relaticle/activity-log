...
description: Read-only admin audit trail — own log only, role-gated visibility, sensitive-field redaction.
navigation:
  icon: i-lucide-shield
seo:
  description: Recipe — role-gated User audit timeline with own-log filtering and a wrapping renderer that redacts sensitive fields like password and remember_token.
  ogImage: /preview.png
---
