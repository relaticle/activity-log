...
> Brand the timeline - custom renderers and Tailwind theme integration.

The timeline's look and feel is pluggable at two levels: **renderers** control the markup of each entry, and the **Tailwind theme** controls the utility classes available to Blade views.
...
The plugin's Blade views use Tailwind utilities. If your panel has a compiled theme, include the plugin's views in its source list so the utilities actually get compiled:
...
Without this line, you may see unstyled or partially-styled timeline entries in production builds.
