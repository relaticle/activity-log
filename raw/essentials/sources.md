...
<tbody>
  <tr>
    <td>
      <code>
        event($column, $event, $icon = null, $color = null, $when = null)
      </code>
    </td>
  ...
  <tr>
    ...
    <td>
      SQL-level query modifier — receives the query builder. Use for tenant scopes, soft-delete, archived flags.
    </td>
  </tr>
  ...
  <tr>
    <td>
      <code>
        title(Closure $resolver)
      </code>
    </td>
    
    <td>
      Per-row resolver for the entry title. Receives the related row, returns <code>
        string
      </code>
  ...
  <tr>
    <td>
      <code>
        description(Closure $resolver)
      </code>
    </td>
    
    <td>
      Per-row resolver for the entry description. Receives the related row, returns <code>
        string
      </code>
  ...
  <tr>
    <td>
      <code>
        causer(Closure|string $resolver)
      </code>
    </td>
    
    <td>
      Relation name as a <code>
        string
      </code>
